...
SOURCES = \
	__init__.py \
	vectorlayer_dxf.py vectorlayer_dxf_dialog.py

PLUGINNAME = vectorlayer_dxf

PY_FILES = \
	__init__.py \
	vectorlayer_dxf.py vectorlayer_dxf_dialog.py

UI_FILES = vectorlayer_dxf_dialog_base.ui
...
QGISDIR=C:\Users\juanort\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
